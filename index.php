...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container"> <a class="navbar-brand" href="index.php">Employee Portal</a> </div>
  </nav>
  <div class="container login_page">
    <div class="row m-2">
      <div class="col-md-5 border border-secondary m-auto p-4 login_form">
        <div class="text-center">
            <?php
              if(isset($_SESSION['error'])){
                echo "<span class='p-2 bg-danger text-white'>" . $_SESSION['error']."</span>";
        ...
        <h5 class="text-center pb-2 mt-3">Employee Login</h5>
...
<?php
  ...
  if(isset($_POST['login_btn'])){
    ...
    $user_pass = mysqli_real_escape_string($con, sha1($_POST['user_pass']));
    $sql = "SELECT * FROM `user_table` WHERE user_id = '$user_id' AND user_pass = '$user_pass'";
